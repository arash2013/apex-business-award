        ...
        conn.execute(
            sa.text("""
                ...
                VALUES (:id, :biz_id, :area_id, :cat_id, 'google',
                    ...
                    CASE WHEN :status_text IN ('purchased','fulfilled') THEN CAST(:now AS TIMESTAMPTZ) ELSE NULL END,
                    CASE WHEN :status_text = 'fulfilled' THEN CAST(:now AS TIMESTAMPTZ) ELSE NULL END,
