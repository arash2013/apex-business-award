...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("platform", sa.Enum("google", "yelp", name="platform"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("tier", sa.Enum("basic", "pro", "premium", name="awardtier"), nullable=False),
        sa.Column("status", sa.Enum("offered", "purchased", "fulfilled", "expired", name="awardstatus"), nullable=False, server_default="offered"),
    ...
    op.create_table(
        ...
        sa.Column("asset_type", sa.Enum("badge", "certificate", "social_kit", "plaque_order", name="assettype"), nullable=False),
        sa.Column("file_url", sa.String(1024), nullable=True),
        sa.Column("status", sa.Enum("pending", "generated", "delivered", name="assetstatus"), nullable=False, server_default="pending"),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum("pending", "sent", "opened", "clicked", "responded", "bounced", "unsubscribed", name="outreachstatus"), nullable=False, server_default="pending"),
